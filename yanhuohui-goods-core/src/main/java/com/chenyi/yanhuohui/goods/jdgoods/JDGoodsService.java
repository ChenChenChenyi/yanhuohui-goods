...
public class JDGoodsService {
     ...
     * 获取京东商品价格
     */
    public List<JDGetSellPriceDTO> getSellPrice(List<String> skuList){
        //请求URL
        String requestUrl = jdUrlPrefix + "/api/price/getSellPrice";
        //构建请求参数
        ...
        return JSONObject.parseArray(response,JDGetSellPriceDTO.class);
    }
